...
const _: () = {
    ...
    ["Offset of field: _IO_FILE::_codecvt"][::std::mem::offset_of!(_IO_FILE, _codecvt) - 88usize];
    ["Offset of field: _IO_FILE::_wide_data"]
        [::std::mem::offset_of!(_IO_FILE, _wide_data) - 92usize];
    ["Offset of field: _IO_FILE::_freeres_list"]
        [::std::mem::offset_of!(_IO_FILE, _freeres_list) - 96usize];
    ["Offset of field: _IO_FILE::_freeres_buf"]
        [::std::mem::offset_of!(_IO_FILE, _freeres_buf) - 100usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTLenString"][::std::mem::size_of::<MQTTLenString>() - 8usize];
    ["Alignment of MQTTLenString"][::std::mem::align_of::<MQTTLenString>() - 4usize];
    ["Offset of field: MQTTLenString::len"][::std::mem::offset_of!(MQTTLenString, len) - 0usize];
    ["Offset of field: MQTTLenString::data"][::std::mem::offset_of!(MQTTLenString, data) - 4usize];
};
#[repr(C)]
#[derive(Copy, Clone)]
...
const _: () = {
    ["Size of MQTTProperty__bindgen_ty_1__bindgen_ty_1"]
        [::std::mem::size_of::<MQTTProperty__bindgen_ty_1__bindgen_ty_1>() - 16usize];
    ["Alignment of MQTTProperty__bindgen_ty_1__bindgen_ty_1"]
        [::std::mem::align_of::<MQTTProperty__bindgen_ty_1__bindgen_ty_1>() - 4usize];
    ...
    ["Offset of field: MQTTProperty__bindgen_ty_1__bindgen_ty_1::value"]
        [::std::mem::offset_of!(MQTTProperty__bindgen_ty_1__bindgen_ty_1, value) - 8usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTProperty__bindgen_ty_1"]
        [::std::mem::size_of::<MQTTProperty__bindgen_ty_1>() - 16usize];
    ["Alignment of MQTTProperty__bindgen_ty_1"]
        [::std::mem::align_of::<MQTTProperty__bindgen_ty_1>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTProperty"][::std::mem::size_of::<MQTTProperty>() - 20usize];
    ["Alignment of MQTTProperty"][::std::mem::align_of::<MQTTProperty>() - 4usize];
    ["Offset of field: MQTTProperty::identifier"]
        [::std::mem::offset_of!(MQTTProperty, identifier) - 0usize];
    ["Offset of field: MQTTProperty::value"][::std::mem::offset_of!(MQTTProperty, value) - 4usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTProperties"][::std::mem::size_of::<MQTTProperties>() - 16usize];
    ["Alignment of MQTTProperties"][::std::mem::align_of::<MQTTProperties>() - 4usize];
    ...
    ["Offset of field: MQTTProperties::array"]
        [::std::mem::offset_of!(MQTTProperties, array) - 12usize];
};
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTClient_persistence"][::std::mem::size_of::<MQTTClient_persistence>() - 36usize];
    ["Alignment of MQTTClient_persistence"]
        [::std::mem::align_of::<MQTTClient_persistence>() - 4usize];
    ...
    ["Offset of field: MQTTClient_persistence::popen"]
        [::std::mem::offset_of!(MQTTClient_persistence, popen) - 4usize];
    ["Offset of field: MQTTClient_persistence::pclose"]
        [::std::mem::offset_of!(MQTTClient_persistence, pclose) - 8usize];
    ["Offset of field: MQTTClient_persistence::pput"]
        [::std::mem::offset_of!(MQTTClient_persistence, pput) - 12usize];
    ["Offset of field: MQTTClient_persistence::pget"]
        [::std::mem::offset_of!(MQTTClient_persistence, pget) - 16usize];
    ["Offset of field: MQTTClient_persistence::premove"]
        [::std::mem::offset_of!(MQTTClient_persistence, premove) - 20usize];
    ["Offset of field: MQTTClient_persistence::pkeys"]
        [::std::mem::offset_of!(MQTTClient_persistence, pkeys) - 24usize];
    ["Offset of field: MQTTClient_persistence::pclear"]
        [::std::mem::offset_of!(MQTTClient_persistence, pclear) - 28usize];
    ["Offset of field: MQTTClient_persistence::pcontainskey"]
        [::std::mem::offset_of!(MQTTClient_persistence, pcontainskey) - 32usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTAsync_message"][::std::mem::size_of::<MQTTAsync_message>() - 48usize];
    ["Alignment of MQTTAsync_message"][::std::mem::align_of::<MQTTAsync_message>() - 4usize];
    ...
    ["Offset of field: MQTTAsync_message::payload"]
        [::std::mem::offset_of!(MQTTAsync_message, payload) - 12usize];
    ["Offset of field: MQTTAsync_message::qos"]
        [::std::mem::offset_of!(MQTTAsync_message, qos) - 16usize];
    ["Offset of field: MQTTAsync_message::retained"]
        [::std::mem::offset_of!(MQTTAsync_message, retained) - 20usize];
    ["Offset of field: MQTTAsync_message::dup"]
        [::std::mem::offset_of!(MQTTAsync_message, dup) - 24usize];
    ["Offset of field: MQTTAsync_message::msgid"]
        [::std::mem::offset_of!(MQTTAsync_message, msgid) - 28usize];
    ["Offset of field: MQTTAsync_message::properties"]
        [::std::mem::offset_of!(MQTTAsync_message, properties) - 32usize];
};
...
const _: () = {
    ["Size of MQTTAsync_connectData__bindgen_ty_1"]
        [::std::mem::size_of::<MQTTAsync_connectData__bindgen_ty_1>() - 8usize];
    ["Alignment of MQTTAsync_connectData__bindgen_ty_1"]
        [::std::mem::align_of::<MQTTAsync_connectData__bindgen_ty_1>() - 4usize];
    ...
    ["Offset of field: MQTTAsync_connectData__bindgen_ty_1::data"]
        [::std::mem::offset_of!(MQTTAsync_connectData__bindgen_ty_1, data) - 4usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTAsync_connectData"][::std::mem::size_of::<MQTTAsync_connectData>() - 20usize];
    ["Alignment of MQTTAsync_connectData"]
        [::std::mem::align_of::<MQTTAsync_connectData>() - 4usize];
    ...
    ["Offset of field: MQTTAsync_connectData::binarypwd"]
        [::std::mem::offset_of!(MQTTAsync_connectData, binarypwd) - 12usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTAsync_failureData"][::std::mem::size_of::<MQTTAsync_failureData>() - 12usize];
    ["Alignment of MQTTAsync_failureData"]
        [::std::mem::align_of::<MQTTAsync_failureData>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTAsync_failureData5"][::std::mem::size_of::<MQTTAsync_failureData5>() - 44usize];
    ["Alignment of MQTTAsync_failureData5"]
        [::std::mem::align_of::<MQTTAsync_failureData5>() - 4usize];
    ...
    ["Offset of field: MQTTAsync_failureData5::code"]
        [::std::mem::offset_of!(MQTTAsync_failureData5, code) - 32usize];
    ["Offset of field: MQTTAsync_failureData5::message"]
        [::std::mem::offset_of!(MQTTAsync_failureData5, message) - 36usize];
    ["Offset of field: MQTTAsync_failureData5::packet_type"]
        [::std::mem::offset_of!(MQTTAsync_failureData5, packet_type) - 40usize];
};
#[repr(C)]
#[derive(Copy, Clone)]
...
const _: () = {
    ["Size of MQTTAsync_successData__bindgen_ty_1__bindgen_ty_1"]
        [::std::mem::size_of::<MQTTAsync_successData__bindgen_ty_1__bindgen_ty_1>() - 52usize];
    ["Alignment of MQTTAsync_successData__bindgen_ty_1__bindgen_ty_1"]
        [::std::mem::align_of::<MQTTAsync_successData__bindgen_ty_1__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of MQTTAsync_successData__bindgen_ty_1__bindgen_ty_2"]
        [::std::mem::size_of::<MQTTAsync_successData__bindgen_ty_1__bindgen_ty_2>() - 12usize];
    ["Alignment of MQTTAsync_successData__bindgen_ty_1__bindgen_ty_2"]
        [::std::mem::align_of::<MQTTAsync_successData__bindgen_ty_1__bindgen_ty_2>() - 4usize];
...
const _: () = {
    ["Size of MQTTAsync_successData__bindgen_ty_1"]
        [::std::mem::size_of::<MQTTAsync_successData__bindgen_ty_1>() - 52usize];
    ["Alignment of MQTTAsync_successData__bindgen_ty_1"]
        [::std::mem::align_of::<MQTTAsync_successData__bindgen_ty_1>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTAsync_successData"][::std::mem::size_of::<MQTTAsync_successData>() - 56usize];
    ["Alignment of MQTTAsync_successData"]
        [::std::mem::align_of::<MQTTAsync_successData>() - 4usize];
    ...
    ["Offset of field: MQTTAsync_successData::alt"]
        [::std::mem::offset_of!(MQTTAsync_successData, alt) - 4usize];
};
#[repr(C)]
#[derive(Copy, Clone)]
...
const _: () = {
    ["Size of MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_1"]
        [::std::mem::size_of::<MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_1>() - 8usize];
    ["Alignment of MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_1"]
        [::std::mem::align_of::<MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_2"]
        [::std::mem::size_of::<MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_2>() - 52usize];
    ["Alignment of MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_2"]
        [::std::mem::align_of::<MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_2>() - 4usize];
...
const _: () = {
    ["Size of MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_3"]
        [::std::mem::size_of::<MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_3>() - 12usize];
    ["Alignment of MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_3"]
        [::std::mem::align_of::<MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_3>() - 4usize];
...
const _: () = {
    ["Size of MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_4"]
        [::std::mem::size_of::<MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_4>() - 8usize];
    ["Alignment of MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_4"]
        [::std::mem::align_of::<MQTTAsync_successData5__bindgen_ty_1__bindgen_ty_4>() - 4usize];
...
const _: () = {
    ["Size of MQTTAsync_successData5__bindgen_ty_1"]
        [::std::mem::size_of::<MQTTAsync_successData5__bindgen_ty_1>() - 52usize];
    ["Alignment of MQTTAsync_successData5__bindgen_ty_1"]
        [::std::mem::align_of::<MQTTAsync_successData5__bindgen_ty_1>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTAsync_successData5"][::std::mem::size_of::<MQTTAsync_successData5>() - 84usize];
    ["Alignment of MQTTAsync_successData5"]
        [::std::mem::align_of::<MQTTAsync_successData5>() - 4usize];
    ...
    ["Offset of field: MQTTAsync_successData5::alt"]
        [::std::mem::offset_of!(MQTTAsync_successData5, alt) - 32usize];
};
...
const _: () = {
    ["Size of MQTTAsync_responseOptions"]
        [::std::mem::size_of::<MQTTAsync_responseOptions>() - 68usize];
    ["Alignment of MQTTAsync_responseOptions"]
        [::std::mem::align_of::<MQTTAsync_responseOptions>() - 4usize];
    ...
    ["Offset of field: MQTTAsync_responseOptions::onFailure"]
        [::std::mem::offset_of!(MQTTAsync_responseOptions, onFailure) - 12usize];
    ["Offset of field: MQTTAsync_responseOptions::context"]
        [::std::mem::offset_of!(MQTTAsync_responseOptions, context) - 16usize];
    ["Offset of field: MQTTAsync_responseOptions::token"]
        [::std::mem::offset_of!(MQTTAsync_responseOptions, token) - 20usize];
    ["Offset of field: MQTTAsync_responseOptions::onSuccess5"]
        [::std::mem::offset_of!(MQTTAsync_responseOptions, onSuccess5) - 24usize];
    ["Offset of field: MQTTAsync_responseOptions::onFailure5"]
        [::std::mem::offset_of!(MQTTAsync_responseOptions, onFailure5) - 28usize];
    ["Offset of field: MQTTAsync_responseOptions::properties"]
        [::std::mem::offset_of!(MQTTAsync_responseOptions, properties) - 32usize];
    ["Offset of field: MQTTAsync_responseOptions::subscribeOptions"]
        [::std::mem::offset_of!(MQTTAsync_responseOptions, subscribeOptions) - 48usize];
    ["Offset of field: MQTTAsync_responseOptions::subscribeOptionsCount"]
        [::std::mem::offset_of!(MQTTAsync_responseOptions, subscribeOptionsCount) - 60usize];
    ["Offset of field: MQTTAsync_responseOptions::subscribeOptionsList"]
        [::std::mem::offset_of!(MQTTAsync_responseOptions, subscribeOptionsList) - 64usize];
};
...
const _: () = {
    ["Size of MQTTAsync_willOptions__bindgen_ty_1"]
        [::std::mem::size_of::<MQTTAsync_willOptions__bindgen_ty_1>() - 8usize];
    ["Alignment of MQTTAsync_willOptions__bindgen_ty_1"]
        [::std::mem::align_of::<MQTTAsync_willOptions__bindgen_ty_1>() - 4usize];
    ...
    ["Offset of field: MQTTAsync_willOptions__bindgen_ty_1::data"]
        [::std::mem::offset_of!(MQTTAsync_willOptions__bindgen_ty_1, data) - 4usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTAsync_willOptions"][::std::mem::size_of::<MQTTAsync_willOptions>() - 32usize];
    ["Alignment of MQTTAsync_willOptions"]
        [::std::mem::align_of::<MQTTAsync_willOptions>() - 4usize];
    ...
    ["Offset of field: MQTTAsync_willOptions::message"]
        [::std::mem::offset_of!(MQTTAsync_willOptions, message) - 12usize];
    ["Offset of field: MQTTAsync_willOptions::retained"]
        [::std::mem::offset_of!(MQTTAsync_willOptions, retained) - 16usize];
    ["Offset of field: MQTTAsync_willOptions::qos"]
        [::std::mem::offset_of!(MQTTAsync_willOptions, qos) - 20usize];
    ["Offset of field: MQTTAsync_willOptions::payload"]
        [::std::mem::offset_of!(MQTTAsync_willOptions, payload) - 24usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTAsync_SSLOptions"][::std::mem::size_of::<MQTTAsync_SSLOptions>() - 72usize];
    ["Alignment of MQTTAsync_SSLOptions"][::std::mem::align_of::<MQTTAsync_SSLOptions>() - 4usize];
    ...
    ["Offset of field: MQTTAsync_SSLOptions::keyStore"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, keyStore) - 12usize];
    ["Offset of field: MQTTAsync_SSLOptions::privateKey"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, privateKey) - 16usize];
    ["Offset of field: MQTTAsync_SSLOptions::privateKeyPassword"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, privateKeyPassword) - 20usize];
    ["Offset of field: MQTTAsync_SSLOptions::enabledCipherSuites"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, enabledCipherSuites) - 24usize];
    ["Offset of field: MQTTAsync_SSLOptions::enableServerCertAuth"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, enableServerCertAuth) - 28usize];
    ["Offset of field: MQTTAsync_SSLOptions::sslVersion"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, sslVersion) - 32usize];
    ["Offset of field: MQTTAsync_SSLOptions::verify"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, verify) - 36usize];
    ["Offset of field: MQTTAsync_SSLOptions::CApath"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, CApath) - 40usize];
    ["Offset of field: MQTTAsync_SSLOptions::ssl_error_cb"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, ssl_error_cb) - 44usize];
    ["Offset of field: MQTTAsync_SSLOptions::ssl_error_context"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, ssl_error_context) - 48usize];
    ["Offset of field: MQTTAsync_SSLOptions::ssl_psk_cb"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, ssl_psk_cb) - 52usize];
    ["Offset of field: MQTTAsync_SSLOptions::ssl_psk_context"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, ssl_psk_context) - 56usize];
    ["Offset of field: MQTTAsync_SSLOptions::disableDefaultTrustStore"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, disableDefaultTrustStore) - 60usize];
    ["Offset of field: MQTTAsync_SSLOptions::protos"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, protos) - 64usize];
    ["Offset of field: MQTTAsync_SSLOptions::protos_len"]
        [::std::mem::offset_of!(MQTTAsync_SSLOptions, protos_len) - 68usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTAsync_nameValue"][::std::mem::size_of::<MQTTAsync_nameValue>() - 8usize];
    ["Alignment of MQTTAsync_nameValue"][::std::mem::align_of::<MQTTAsync_nameValue>() - 4usize];
    ...
    ["Offset of field: MQTTAsync_nameValue::value"]
        [::std::mem::offset_of!(MQTTAsync_nameValue, value) - 4usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ["Size of MQTTAsync_connectOptions__bindgen_ty_1"]
        [::std::mem::size_of::<MQTTAsync_connectOptions__bindgen_ty_1>() - 8usize];
    ["Alignment of MQTTAsync_connectOptions__bindgen_ty_1"]
        [::std::mem::align_of::<MQTTAsync_connectOptions__bindgen_ty_1>() - 4usize];
    ...
    ["Offset of field: MQTTAsync_connectOptions__bindgen_ty_1::data"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions__bindgen_ty_1, data) - 4usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MQTTAsync_connectOptions"]
        [::std::mem::size_of::<MQTTAsync_connectOptions>() - 120usize];
    ["Alignment of MQTTAsync_connectOptions"]
        [::std::mem::align_of::<MQTTAsync_connectOptions>() - 4usize];
    ...
    ["Offset of field: MQTTAsync_connectOptions::will"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, will) - 20usize];
    ["Offset of field: MQTTAsync_connectOptions::username"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, username) - 24usize];
    ["Offset of field: MQTTAsync_connectOptions::password"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, password) - 28usize];
    ["Offset of field: MQTTAsync_connectOptions::connectTimeout"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, connectTimeout) - 32usize];
    ["Offset of field: MQTTAsync_connectOptions::retryInterval"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, retryInterval) - 36usize];
    ["Offset of field: MQTTAsync_connectOptions::ssl"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, ssl) - 40usize];
    ["Offset of field: MQTTAsync_connectOptions::onSuccess"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, onSuccess) - 44usize];
    ["Offset of field: MQTTAsync_connectOptions::onFailure"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, onFailure) - 48usize];
    ["Offset of field: MQTTAsync_connectOptions::context"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, context) - 52usize];
    ["Offset of field: MQTTAsync_connectOptions::serverURIcount"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, serverURIcount) - 56usize];
    ["Offset of field: MQTTAsync_connectOptions::serverURIs"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, serverURIs) - 60usize];
    ["Offset of field: MQTTAsync_connectOptions::MQTTVersion"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, MQTTVersion) - 64usize];
    ["Offset of field: MQTTAsync_connectOptions::automaticReconnect"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, automaticReconnect) - 68usize];
    ["Offset of field: MQTTAsync_connectOptions::minRetryInterval"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, minRetryInterval) - 72usize];
    ["Offset of field: MQTTAsync_connectOptions::maxRetryInterval"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, maxRetryInterval) - 76usize];
    ["Offset of field: MQTTAsync_connectOptions::binarypwd"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, binarypwd) - 80usize];
    ["Offset of field: MQTTAsync_connectOptions::cleanstart"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, cleanstart) - 88usize];
    ["Offset of field: MQTTAsync_connectOptions::connectProperties"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, connectProperties) - 92usize];
    ["Offset of field: MQTTAsync_connectOptions::willProperties"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, willProperties) - 96usize];
    ["Offset of field: MQTTAsync_connectOptions::onSuccess5"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, onSuccess5) - 100usize];
    ["Offset of field: MQTTAsync_connectOptions::onFailure5"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, onFailure5) - 104usize];
    ["Offset of field: MQTTAsync_connectOptions::httpHeaders"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, httpHeaders) - 108usize];
    ["Offset of field: MQTTAsync_connectOptions::httpProxy"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, httpProxy) - 112usize];
    ["Offset of field: MQTTAsync_connectOptions::httpsProxy"]
        [::std::mem::offset_of!(MQTTAsync_connectOptions, httpsProxy) - 116usize];
};
unsafe extern "C" {
...
const _: () = {
    ["Size of MQTTAsync_disconnectOptions"]
        [::std::mem::size_of::<MQTTAsync_disconnectOptions>() - 52usize];
    ["Alignment of MQTTAsync_disconnectOptions"]
        [::std::mem::align_of::<MQTTAsync_disconnectOptions>() - 4usize];
    ...
    ["Offset of field: MQTTAsync_disconnectOptions::onSuccess"]
        [::std::mem::offset_of!(MQTTAsync_disconnectOptions, onSuccess) - 12usize];
    ["Offset of field: MQTTAsync_disconnectOptions::onFailure"]
        [::std::mem::offset_of!(MQTTAsync_disconnectOptions, onFailure) - 16usize];
    ["Offset of field: MQTTAsync_disconnectOptions::context"]
        [::std::mem::offset_of!(MQTTAsync_disconnectOptions, context) - 20usize];
    ["Offset of field: MQTTAsync_disconnectOptions::properties"]
        [::std::mem::offset_of!(MQTTAsync_disconnectOptions, properties) - 24usize];
    ["Offset of field: MQTTAsync_disconnectOptions::reasonCode"]
        [::std::mem::offset_of!(MQTTAsync_disconnectOptions, reasonCode) - 40usize];
    ["Offset of field: MQTTAsync_disconnectOptions::onSuccess5"]
        [::std::mem::offset_of!(MQTTAsync_disconnectOptions, onSuccess5) - 44usize];
    ["Offset of field: MQTTAsync_disconnectOptions::onFailure5"]
        [::std::mem::offset_of!(MQTTAsync_disconnectOptions, onFailure5) - 48usize];
};
unsafe extern "C" {
